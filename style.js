//#1 Now we will be following the steps in the agora api documentation to create what we need
//so it first says, create a client(person who joins our video call)
let client = AgoraRTC.createClient({mode:'rtc', codec:"vp8"})


//#2 create a configuration object 
let config = {
    appid:'3da26343b1de4c83be5364f219a9d42f',
    token:'007eJxTYGjZOm/RcZnHU5b8aZ++4hrnB1OzOCNtrq9KW/dO+eiyUOqfAoNxSqKRmbGJcZJhSqpJsoVxUqqpsZlJmpGhZaJliolRGo8aS0pDICODTfNOJkYGCATxuRkKUhOTU5OKMlPSUxkYAKGZInM=',
    uid: null,
    channel:'peacebridge',
}


//#3 - local tracks for the user(audio and video)
let localTracks = {
    audioTrack:null,
    videoTrack:null
}

//#4 - remote tracks are for other users and not the local user
let localTrackState = {
...
//query selector(event handler) to connect tot he join btn
